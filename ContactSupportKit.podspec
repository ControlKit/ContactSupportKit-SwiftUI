Pod::Spec.new do |spec|
  spec.name         = 'ContactSupportKit'
  spec.version      = '0.0.1'
  spec.summary      = 'A short description of ContactSupportKit.'

  spec.license = 'MIT'
  spec.summary = 'The launch ContactSupport in all app is handled easily.'
  spec.homepage = 'https://github.com/ControlKit/ContactSupportKit'
  spec.source = { :git => 'https://github.com/ControlKit/ContactSupportKit.git', :tag => "#{spec.version}" }
